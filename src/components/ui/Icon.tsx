...
const paths: Record<string, React.ReactNode> = {
  ...
  mosque: (
    <>
      <path d="M4 20h16M3 20V11l2-4 2 4v9M17 20V11l2-4 2 4v9" />
      <path d="M7 15c0-3.5 2-6 5-6s5 2.5 5 6v5H7v-5Z" />
      <path d="M12 9V5M10.5 3.5a1.5 1.5 0 0 0 3 0" />
      <path d="M10.5 20v-3a1.5 1.5 0 0 1 3 0v3" />
    </>
  ),
  crescent: (
    <>
      <path d="M16 16.5A7.5 7.5 0 1 1 8.5 3c-.2 0-.4 0-.6.03A7 7 0 0 0 16 16.5Z" />
      <path d="m16 4 .7 1.4 1.5.2-1.1 1.1.3 1.5-1.4-.7-1.4.7.3-1.5-1.1-1.1 1.5-.2L16 4Z" />
    </>
  ),
  quran: (
    <>
      <path d="M4 6c3-1 6-1 8 1 2-2 5-2 8-1v10c-3-1-6-1-8 1-2-2-5-2-8-1V6Z" />
      <path d="M12 7v10M6 19l4-3M18 19l-4-3" />
    </>
  ),
  kaaba: (
    <>
  ...
  tasbih: (
    <>
      <path d="M12 3a6 6 0 0 1 6 6c0 4-6 9-6 9s-6-5-6-9a6 6 0 0 1 6-6Z" />
      <path d="M12 18v4M9.5 22h5" />
    </>
  ),

  /* --- Fashion & Apparel -------------------------------------------------- */
  shirt: (
    <path d="M6 3 2 7l3 3 1-1v11a1 1 0 0 0 1 1h10a1 1 0 0 0 1-1V9l1 1 3-3-4-4a4 4 0 0 1-8 0Z" />
  ),
  dress: (
    <>
      <path d="M9 3h6l2 4-2 3 4 10a1 1 0 0 1-1 1H6a1 1 0 0 1-1-1l4-10-2-3 2-4Z" />
      <path d="M9 3a3 3 0 0 0 6 0" />
    </>
  ),
  pants: (
    <>
      <path d="M5 4h14v4l-2 12h-4l-1-7-1 7H7L5 8V4Z" />
      <path d="M9 4v4h6V4" />
    </>
  ),
  shoes: (
    <>
      ...
      <path d="M2 17v-4a3 3 0 0 1 2-2.8l7-2.2 4 4h5a2 2 0 0 1 2 2v3" />
    </>
  ),
  bag: (
    <>
      <rect x="4" y="8" width="16" height="13" rx="2" />
      <path d="M8 8V6a4 4 0 0 1 8 0v2M12 12v2" />
    </>
  ),
  sunglasses: (
    <>
      <path d="M3 13h6a2.5 2.5 0 0 0 2.5-2.5V8H2v2.5A2.5 2.5 0 0 0 3 13ZM15 13h6a2.5 2.5 0 0 0 1-2.5V8h-9.5v2.5a2.5 2.5 0 0 0 2.5 2.5Z" />
      <path d="M2 8l2.5-4.5h1M22 8l-2.5-4.5h-1M10.5 9h3" />
    </>
  ),
  jewelry: (
    <>
  ...
  perfume: (
    <>
      ...
      <path d="M10 9V5h4v4M12 2v3M9 2h6" />
      <circle cx="12" cy="15" r="2" />
    </>
  ),
  lipstick: (
    <>
      <path d="M8 12h8v9a1 1 0 0 1-1 1H9a1 1 0 0 1-1-1v-9Z" />
      <path d="M9 12V8l6-3v7" />
      <path d="M8 16h8" />
    </>
  ),
  scissors: (
  ...
  /* --- Health & Fitness --------------------------------------------------- */
  heart: (
    <path d="M19 14c1.5-1.5 2-3.5 2-5.5a5.5 5.5 0 0 0-9.5-3.8A5.5 5.5 0 0 0 2 8.5c0 2 0.5 4 2 5.5l8 8 7-8Z" />
  ),
  pill: (
    <path d="m10.5 4.5 9 9a4.24 4.24 0 0 1-6 6l-9-9a4.24 4.24 0 0 1 6-6ZM8 10l6 6" />
  ),
  dumbbell: (
  ...
  utensils: (
    <>
      <path d="M18 2v20M21 2v6a3 3 0 0 1-3 3M14 2v6a3 3 0 0 0 3 3" />
      <path d="M6 2v7a3 3 0 0 0 3 3v10M3 2v5a3 3 0 0 0 3 3" />
    </>
  ),
  cup: (
    <>
      <path d="M4 6h12v9a4 4 0 0 1-4 4H8a4 4 0 0 1-4-4V6Z" />
  ...
  bed: (
    <>
      <path d="M2 4v16M2 9h18a2 2 0 0 1 2 2v9M2 16h20M6 9v3M10 9v3" />
    </>
  ),
  ...
  apple: (
    <>
      <path d="M12 20.5c-2.5 1-5 0-6.5-1.5A7.5 7.5 0 0 1 4 12c0-3.8 3-7 6.5-7 1.5 0 2.5.5 3.5 1.5 1-1 2-1.5 3.5-1.5 3.5 0 6.5 3.2 6.5 7 0 3.5-1 6-2.5 7.5-1.5 1.5-4 2.5-6.5 1.5Z" />
      <path d="M12 5V2c1.5 0 3 .8 3.5 2" />
    </>
  ),
  basket: (
    <>
      <path d="m4 10 2 10a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2l2-10H4ZM2 10h20M9 10V6a3 3 0 0 1 6 0v4" />
    </>
  ),
  ...
  baby: (
    <>
      ...
      <path d="M18 17H6l-3-8h15a3 3 0 0 1 3 3v1a4 4 0 0 1-4 4ZM7 9V4h2" />
    </>
  ),
  feeder: (
    <>
      <rect x="7" y="9" width="10" height="12" rx="3" />
      <path d="M9 9V5h6v4M11 5V2.5a1 1 0 0 1 2 0V5" />
      <path d="M7 13h4M7 16h3" />
    </>
  ),
  ...
  gift: (
    <>
      ...
      <path d="M12 8v13M3 13h18M12 8H8a2.5 2.5 0 1 1 0-5c3 0 4 5 4 5s1-5 4-5a2.5 2.5 0 1 1 0 5h-4" />
    </>
  ),
  flame: (
    <>
      <path d="M8.5 14.5A2.5 2.5 0 0 0 11 12c0-1.4-.5-2-1-3.5 2 .5 4 2 4 4.5a3 3 0 0 1-3 3c-1.5 0-2.5-.9-2.5-1.5Z" />
      <path d="M12 2c2 3.5 7 5.5 7 11a7 7 0 1 1-14 0c0-4 3-7 5-9.5.5 1.5 1 2.5 2 2.5 0-1.5 0-2.5 0-4Z" />
    </>
  ),
  wrench: (
